    ...
    <>
      ...
      <section className="workshop-intro">
        <div className="intro-card">
          <h2 className="intro-title">Khóa Pastel nâng cao</h2>
          <img src={imgResin} alt="Khóa Pastel nâng cao" className="intro-image" />
          <p className="intro-text">
            Khóa Pastel nâng cao được thiết kế dành cho cả những người mới bắt đầu lẫn những ai đã có kinh nghiệm cơ bản trong việc tạo sản phẩm từ nhựa epoxy. 
