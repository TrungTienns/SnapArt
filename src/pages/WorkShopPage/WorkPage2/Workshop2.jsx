    ...
    <>
      ...
      <section className="workshop-intro">
        <div className="intro-card">
          <h2 className="intro-title">Khóa màu Acrylic - Kid</h2>
          <img src={imgResin} alt="Khóa màu Acrylic - Kid" className="intro-image" />
          <p className="intro-text">
            Khóa màu Acrylic - Kid được thiết kế dành cho cả những người mới bắt đầu lẫn những ai đã có kinh nghiệm cơ bản trong việc tạo sản phẩm từ nhựa epoxy. 
